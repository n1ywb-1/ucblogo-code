...
// end include: /home/jeff/emsdk/upstream/emscripten/src/emrun_prejs.js
...
function findWasmBinary() {
  return locateFile("ucblogo.wasm");
}
...
async function instantiateAsync(binary, binaryFile, imports) {
  if (!binary && typeof WebAssembly.instantiateStreaming == "function" && !isFileURI(binaryFile) && !ENVIRONMENT_IS_NODE && !ENVIRONMENT_IS_SHELL) {
    try {
...
function em_fflush(fh) {
  _fflush(fh);
}

var wasmImports = {
  /** @export */ __assert_fail: ___assert_fail,
  /** @export */ __asyncjs__em_getc,
...
var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 306965164;
...
// include: /home/jeff/emsdk/upstream/emscripten/src/emrun_postjs.js
/**
 * @license
 * Copyright 2013 The Emscripten Authors
 * SPDX-License-Identifier: MIT
